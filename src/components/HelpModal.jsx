...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      'Type / in the chat to see all skills — autocomplete filters as you type',
      '✍️  /essay      — Essay and academic writing coach',
      '📧  /email      — Professional emails with perfect tone & subject lines',
      '💰  /finance    — Personal finance, budgeting, saving & investing',
      '🏥  /health     — Fitness, nutrition, mental wellness & healthy lifestyle',
      '🖼️  /imagen     — Generate stunning AI images with Google Imagen 4',
      '📚  /learn      — Step-by-step Socratic learning tutor for any topic',
      '⚖️  /legal      — Contracts, rights, disclaimers & legal documents',
      '💼  /linkedin   — LinkedIn posts, profile optimizer & networking',
      '🧠  /mindset    — Motivation, journaling, affirmations & confidence',
      '📝  /notes      — Meeting notes, brain dumps & structured summaries',
      '📋  /plan       — Daily schedules, project roadmaps & goal plans',
      '⚡  /prompt     — Write, improve & optimize AI prompts',
      '🧾  /recipe     — Recipes by ingredients, diet, cuisine or time',
      '🔬  /research   — Deep research, fact-checking & competitor analysis',
      '📄  /resume     — Resumes, cover letters & LinkedIn profiles',
      '🎓  /school     — Homework help, exam prep for all subjects',
      '🎤  /speak      — Speeches, pitches, debates & presentation scripts',
      '📑  /summarize  — Summarize articles, meetings, books & documents',
      '✈️  /travel     — Trip itineraries, packing lists & travel tips',
      '🌐  /website    — Generate stunning animated HTML websites',
      '💬  /whatsapp   — Perfect WhatsApp messages for any situation',
      '⚙️  /workflow   — Automation flows, SOPs & process maps',
      '▶️  /youtube    — YouTube content strategy, titles & SEO',
      '💻  /code       — Code review, debugging & architecture advice',
      '📊  /data       — Data analysis, charts, insights & KPI tracking',
      'After selecting a skill, click the subcategory buttons to quickly start a specific type of task',
      '/clear — Return to normal TASKI mode',
    ],
  },
  {
